...
-  **Cerebellar granule cell**
   ...
   **File -> Load ->**
   ...
   1997 <https://modeldb.science/50219>`_ (exported from
   https://neuroconstruct.org/). Click on its soma, and **See
...
-  **Purkinje cell**
   ...
   **File -> Load ->**
   ...
   https://neuroconstruct.org/). The channel specifications are in an
...
-  **All channels cell**
   ...
   **File -> Load ->**
   ...
   https://neuroconstruct.org/). Play around with the channel
