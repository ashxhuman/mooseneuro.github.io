...
----------------------------------------
Binary wheels for MOOSE are available on the  `Github releases page
<https://github.com/MooseNeuro/moose-core/releases>`__. You can download a wheel suitable for your platform and install it directly with pip.
...
For detailed platform instructions, see:
 ...
 - **Windows:** `WindowsBuild.md
   <https://github.com/MooseNeuro/moose-core/blob/master/docs/source/install/index_install.md>`__
