...
The MOOSE community is a collaborative environment where users, developers, and researchers can interact, learn, and contribute. To maintain a welcoming and productive atmosphere, we request that all members follow these guidelines:
...
2. Maintain Professionalism
   - Stay on topic.
   - Avoid spamming, self-promotion, or disruptive behaviour.
...
4. Respect Intellectual Property
   - Attribute the work to its original authors when reusing or referencing it.
...
7. Report Violations
   - Report any behaviour or content that violates these guidelines to the moderators or administrators.
